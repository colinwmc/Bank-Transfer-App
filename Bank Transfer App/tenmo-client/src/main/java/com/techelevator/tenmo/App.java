...
public class App {
	...
	private void viewPendingRequests() {
        // TODO Auto-generated method stub
        //A DISCLAIMER ON THE CODE YOU'LL FIND HERE
        //You'll notice that there's a lot of poor practice in here because most of the code is copied and pasted from viewTransfers. The same is true for sendBucks and requestBucks.
        //I 100% acknowledge that this is sloppy and what I should be doing is pulling the repeated code out into a method that I can call from both locations, adding parameters for
        //anything that needs to be altered slightly. But since this was just an optional bonus, and I really just wanted to see what it entailed, and also because I was very paranoid
        //about breaking the working MVP code that we'd already written, I didn't take the time to do any of this. It also has no tests written for it.
        //-Colin
        Map<Long, String> transferType = new HashMap<>();
        transferType.put(1L, "Request");
        transferType.put(2L, "Send");
